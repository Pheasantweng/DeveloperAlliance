...
-(void)downLoadImage{
    if (self.images && self.images.count > 0) {
        ...
        [self.images enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            [imageView sd_setImageWithURL:[NSURL URLWithString:obj] placeholderImage:self.placeHoldImage completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL)
            {
